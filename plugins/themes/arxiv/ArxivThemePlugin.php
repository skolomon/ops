...
/**
 * @file plugins/themes/arxiv/ArxivThemePlugin.php
 *
 ...
 *
 * @class ArxivThemePlugin
 *
 * @brief Arxiv theme
 */

namespace APP\plugins\themes\arxiv;
...
class ArxivThemePlugin extends ThemePlugin
{
    /**
    ...
    public function init()
    {
        ...
        $this->addOption('typography', 'FieldOptions', [
            'type' => 'radio',
            'label' => __('plugins.themes.arxiv.option.typography.label'),
            'description' => __('plugins.themes.arxiv.option.typography.description'),
            'options' => [
                [
                    'value' => 'notoSans',
                    'label' => __('plugins.themes.arxiv.option.typography.notoSans'),
                ],
                [
                    'value' => 'notoSerif',
                    'label' => __('plugins.themes.arxiv.option.typography.notoSerif'),
                ],
                [
                    'value' => 'notoSerif_notoSans',
                    'label' => __('plugins.themes.arxiv.option.typography.notoSerif_notoSans'),
                ],
                [
                    'value' => 'notoSans_notoSerif',
                    'label' => __('plugins.themes.arxiv.option.typography.notoSans_notoSerif'),
                ],
                [
                    'value' => 'lato',
                    'label' => __('plugins.themes.arxiv.option.typography.lato'),
                ],
                [
                    'value' => 'lora',
                    'label' => __('plugins.themes.arxiv.option.typography.lora'),
                ],
                [
                    'value' => 'lora_openSans',
                    'label' => __('plugins.themes.arxiv.option.typography.lora_openSans'),
                ],
            ],
            'default' => 'notoSans',
        ]);
        ...
        $this->addOption('baseColour', 'FieldColor', [
            'label' => __('plugins.themes.arxiv.option.colour.label'),
            'description' => __('plugins.themes.arxiv.option.colour.description'),
            'default' => '#4385E5',
        ]);
        ...
        $this->addOption('showDescriptionInServerIndex', 'FieldOptions', [
            ...
            'options' => [
                [
                    'value' => true,
                    'label' => __('plugins.themes.arxiv.option.showDescriptionInServerIndex.option'),
                ],
            ],
            'default' => false,
        ]);
        $this->addOption('useHomepageImageAsHeader', 'FieldOptions', [
            'label' => __('plugins.themes.arxiv.option.useHomepageImageAsHeader.label'),
            'description' => __('plugins.themes.arxiv.option.useHomepageImageAsHeader.description'),
            'options' => [
                [
                    'value' => true,
                    'label' => __('plugins.themes.arxiv.option.useHomepageImageAsHeader.option')
                ],
            ],
            'default' => false,
        ]);
        $this->addOption('displayStats', 'FieldOptions', [
            ...
            'options' => [
                [
                    'value' => 'none',
                    'label' => __('plugins.themes.arxiv.option.displayStats.none'),
                ],
                [
                    'value' => 'bar',
                    'label' => __('plugins.themes.arxiv.option.displayStats.bar'),
                ],
                [
                    'value' => 'line',
                    'label' => __('plugins.themes.arxiv.option.displayStats.line'),
                ],
            ],
            'default' => 'none',
        ]);
        ...
        if ($this->getOption('baseColour') !== '#4385E5') {
        ...
        $this->addScript('arxiv', 'js/main.js');
    ...
    {
        return __('plugins.themes.arxiv.name');
    }
    ...
    {
        return __('plugins.themes.arxiv.description');
    }
}

if (!PKP_STRICT_MODE) {
    class_alias('\APP\plugins\themes\arxiv\ArxivThemePlugin', '\ArxivThemePlugin');
}
