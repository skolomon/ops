...
c.content+"</div>");b.scrollTop(0);this.requestedSection_&&(c=d.find('a[name="'+this.requestedSection_+'"]'),c.length&&b.scrollTop(c.offset().top-50-window.scrollY-15));this.getHtmlElement().removeClass("is_loading")};a.pkp.controllers.HelpPanelHandler.prototype.handleContentLinks_=function(b,c){b=a(b).attr("href");c.preventDefault();if("http"==b.substring(0,4))return window.open(b),!1;b=b.split("/");c=b.slice(1).join("/");b=b[0];if(-1<c.indexOf("#")){var d=c.split("#");c=d[0];this.requestedSection_=d[1]}this.loadHelpContent_(c,
